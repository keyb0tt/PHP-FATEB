...
<body>
    <form method="post">
        ...
        Insira o consumo médio por litro (em km) do seu veículo: <input type="number" name="consumoMedio"><br>
        ...
        <?php   
            if(isset($_POST["distancia"]) && isset($_POST["gasolinaValor"])){
                ...
                echo "O valor a ser gasto com combustível em uma viagem de $distancia km será de: R$". number_format((($distancia / $consumoMedio) * $gasolinaValor),2, ",", ",");
            }
        ?>
    </form>
</body>
